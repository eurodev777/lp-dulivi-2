...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-blue-600 selection:text-white antialiased">
      ...
      <header className="sticky top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2 select-none group">
            <div className="w-9 h-9 bg-blue-600 text-white rounded-xl flex items-center justify-center font-black text-lg shadow-md shadow-blue-600/10 group-hover:scale-105 active:scale-95 transition-all">
              D
            </div>
            <div className="flex flex-col">
              <span className="font-display font-black text-lg text-slate-900 leading-none tracking-tight">Dulivi</span>
              <span className="text-[9px] text-blue-600 font-bold tracking-wider leading-none mt-0.5">DELIVERY 2.0</span>
            </div>
          </a>

          {/* Desktop Navigation Links */}
          <nav className="hidden md:flex items-center gap-7 text-xs font-bold text-slate-600 uppercase tracking-wider">
            <a href="#hero" onClick={(e) => handleScrollTo(e, 'hero')} className="hover:text-slate-900 transition-colors">Início</a>
            <a href="#features" onClick={(e) => handleScrollTo(e, 'features')} className="hover:text-slate-900 transition-colors">Funcionalidades</a>
            <a href="#pricing" onClick={(e) => handleScrollTo(e, 'pricing')} className="hover:text-slate-900 transition-colors">Planos</a>
            <a href="#about" onClick={(e) => handleScrollTo(e, 'about')} className="hover:text-slate-900 transition-colors">Sobre nós</a>
            <a href="#blog" onClick={(e) => handleScrollTo(e, 'blog')} className="hover:text-slate-900 transition-colors">Blog</a>
          </nav>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              ...
              <span className="bg-blue-500 text-white text-[9px] px-1 rounded-sm">15 dias</span>
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col gap-4 text-sm font-bold text-slate-600 uppercase tracking-wider">
              <a href="#hero" onClick={(e) => handleScrollTo(e, 'hero')} className="hover:text-slate-950">Início</a>
              <a href="#features" onClick={(e) => handleScrollTo(e, 'features')} className="hover:text-slate-950">Funcionalidades</a>
              <a href="#pricing" onClick={(e) => handleScrollTo(e, 'pricing')} className="hover:text-slate-950">Planos</a>
              <a href="#about" onClick={(e) => handleScrollTo(e, 'about')} className="hover:text-slate-950">Sobre nós</a>
              <a href="#blog" onClick={(e) => handleScrollTo(e, 'blog')} className="hover:text-slate-950">Blog</a>
            </nav>
      ...
      <section id="hero" className="relative py-12 md:py-24 bg-radial-at-t from-blue-50/70 via-white to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            <h1 className="text-4xl md:text-6xl font-display font-black text-slate-900 tracking-tight leading-none">
              Crie <span className="text-blue-600">grátis</span> seu Cardápio Digital para Delivery
            </h1>

            <p className="text-slate-500 text-sm md:text-lg leading-relaxed max-w-xl font-medium">
              Pedidos formatados direto no WhatsApp com atendente virtual integrado por inteligência artificial. Crie o seu canal de vendas sem taxas abusivas e com link próprio.
            </p>

            {/* Checklist of strong features */}
            <ul className="space-y-3.5">
              <li className="flex items-center gap-2.5 text-xs md:text-sm text-slate-700 font-bold">
                <span className="w-5 h-5 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-extrabold text-[10px]">✓</span>
              ...
              <li className="flex items-center gap-2.5 text-xs md:text-sm text-slate-700 font-bold">
                <span className="w-5 h-5 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-extrabold text-[10px]">✓</span>
                <span>Atraia mais clientes locais com anúncios simplificados</span>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100/80 flex gap-4 items-center">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-xs">15 dias grátis</h4>
                <p className="text-[11px] text-slate-400 mt-0.5 leading-normal">Instalação gratuita sem custos iniciais.</p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100/80 flex gap-4 items-center">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-xs">Sem multa rescisória</h4>
                <p className="text-[11px] text-slate-400 mt-0.5 leading-normal">Cancele quando quiser, sem enrolação.</p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100/80 flex gap-4 items-center">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-xs">Suporte 24/7 WhatsApp</h4>
                <p className="text-[11px] text-slate-400 mt-0.5 leading-normal">Prontos para te atender a qualquer hora.</p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100/80 flex gap-4 items-center">
              ...
              <div>
                <h4 className="font-extrabold text-slate-900 text-xs">Ativação em horas</h4>
                <p className="text-[11px] text-slate-400 mt-0.5 leading-normal">Seu menu online pronto no mesmo dia.</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-slate-400 mt-3 text-xs md:text-sm max-w-md mx-auto leading-relaxed">
            Nossos parceiros reduzem o tempo operacional e conquistam independência dos grandes marketplaces locais.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mt-16 max-w-4xl mx-auto">
            ...
            <div className="bg-slate-950/40 border border-slate-800/80 p-6 md:p-8 rounded-2xl space-y-1.5">
              ...
              <span className="text-xs font-bold text-slate-300 block uppercase tracking-wider">Faturados por parceiros</span>
              <p className="text-[11px] text-slate-400 leading-normal">Volume transacionado dentro da nossa plataforma própria.</p>
            </div>
            ...
            <div className="bg-slate-950/40 border border-slate-800/80 p-6 md:p-8 rounded-2xl space-y-1.5">
              ...
              <span className="text-xs font-bold text-slate-300 block uppercase tracking-wider">Restaurantes Ativos</span>
              <p className="text-[11px] text-slate-400 leading-normal">Parceiros vendendo todos os dias em todo o Brasil.</p>
            </div>
            ...
            <div className="bg-slate-950/40 border border-slate-800/80 p-6 md:p-8 rounded-2xl space-y-1.5">
              ...
              <span className="text-xs font-bold text-slate-300 block uppercase tracking-wider">Pedidos Processados</span>
              <p className="text-[11px] text-slate-400 leading-normal">Comunicação inteligente e rápida via WhatsApp e CRM.</p>
            </div>
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-24 space-y-6">
              <div className="space-y-3 max-w-sm">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Conforme você preenche o formulário ao lado e seleciona um tom de cor, o mockup ao lado demonstra fielmente o design moderno que seus clientes vão experimentar.
                </p>
                <div className="h-px bg-slate-200/60 my-2" />
                <div className="flex gap-2 text-[10px] font-bold text-slate-400">
                  <span className="bg-white border border-slate-200 p-1 rounded-sm">✓ Domínio Dulivi Grátis</span>
                  <span className="bg-white border border-slate-200 p-1 rounded-sm">✓ Hospedagem Inclusa</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200/60 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="font-extrabold text-slate-900 text-sm md:text-base">Hospedagem inclusa</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Sua marca em um endereço profissional Dulivi sem pagar por servidores adicionais. Velocidade total com CDN integrada para não perder vendas.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200/60 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="font-extrabold text-slate-900 text-sm md:text-base">WhatsApp Automatizado</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Os pedidos dos clientes chegam formatados e prontos diretamente no seu número de suporte. Sem atrito operacional ou perda de informações.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200/60 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="font-extrabold text-slate-900 text-sm md:text-base">Aumento de Vendas em 40%</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Clientes compram mais através de menus modernos, otimizados com categorizações e sugestões inteligentes de adicionais automáticos.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 bg-blue-600 text-white rounded-xl flex items-center justify-center font-black text-lg shadow-md shadow-blue-600/10">
                D
              </div>
              <span className="font-display font-black text-lg text-white tracking-tight">Dulivi</span>
            </div>
            
            <p className="text-xs text-slate-400 leading-relaxed max-w-sm font-semibold">
              Cardápio Digital para Delivery - Sistema completo que revoluciona a gestão do seu restaurante. Mais vendas, menos operacional, mais tempo livre para você.
            </p>
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="text-white text-xs font-black uppercase tracking-wider">Empresa</h4>
            <ul className="space-y-2 text-xs">
              <li><a href="#about" onClick={(e) => handleScrollTo(e, 'about')} className="hover:text-white transition-colors">Sobre Nós</a></li>
              <li><a href="#features" onClick={(e) => handleScrollTo(e, 'features')} className="hover:text-white transition-colors">Benefícios</a></li>
              <li><a href="#blog" onClick={(e) => handleScrollTo(e, 'blog')} className="hover:text-white transition-colors">Blog</a></li>
              <li><a href="#contact-form-section" onClick={(e) => handleScrollTo(e, 'contact-form-section')} className="hover:text-white transition-colors">Contato</a></li>
            </ul>
          </div>

          {/* Fale Conosco Right Column */}
          <div className="md:col-span-4 space-y-3">
            <h4 className="text-white text-xs font-black uppercase tracking-wider">Fale com a gente</h4>
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  O cardápio digital para o estabelecimento <b className="text-slate-800">{activeSuccessModal}</b> foi criado e está em processo de provisionamento na nuvem!
                </p>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-left text-xs text-slate-600 space-y-1.5 leading-relaxed font-mono">
                <p className="text-blue-600 font-bold font-sans uppercase text-[10px]">Próximas etapas:</p>
          ...
          {toasts.map((toast) => (
            ...
            >
              ...
              <div className="flex-1 space-y-0.5">
                ...
                <p className="text-[10px] opacity-90 leading-relaxed font-semibold">{toast.description}</p>
              </div>
