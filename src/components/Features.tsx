  ...
  const features: FeatureDetail[] = [
    {
      ...
      subtitle:
        "Atendimento humanizado, personalizado e disponível 24h para converter conversas em vendas.",
        ...
        <div className="bg-slate-900 rounded-2xl p-4 text-xs font-mono text-slate-300 space-y-3 shadow-inner border border-slate-800">
          ...
          <div className="space-y-2.5">
            <div className="flex gap-2">
              <span className="bg-slate-800 px-2 py-1 rounded text-slate-400 text-[10px]">
                Cliente
              </span>
              <p className="bg-slate-800 text-white rounded-lg p-2 rounded-tl-none font-sans leading-normal">
                Boa noite! Vocês têm pizza de calabresa de tamanho grande para
                entrega? Quanto fica o frete para o Centro?
              </p>
            </div>
            <motion.div
            ...
            >
              <span className="bg-blue-600/20 text-blue-400 px-2 py-1 rounded text-[10px] self-start border border-blue-500/20">
                Dulivi IA
              </span>
              <div className="bg-blue-600 text-white rounded-lg p-2.5 rounded-tr-none font-sans leading-normal space-y-1.5 max-w-[80%]">
                <p>
                  Olá! Temos sim! 🍕 Nossa Pizza Grande de Calabresa com
                  Catupiry está por <b>R$ 42,00</b>.
                </p>
                <p>
                  Para o Centro, a entrega fica por apenas <b>R$ 5,00</b> e
                  chega em 30-40 min!
                </p>
                <p className="text-[11px] text-blue-100 italic">
                  💡 Deseja adicionar uma Coca-Cola geladinha por apenas R$ 6,00
                  adicionais?
                </p>
              </div>
            </motion.div>
    ...
    },
    {
      ...
      subtitle:
        "Atraia novos clientes locais de forma constante enquanto você foca na cozinha e no atendimento.",
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 flex gap-2.5 items-start">
            ...
            <p className="text-[11px] text-blue-800 leading-snug font-medium">
              Dulivi identificou que os melhores horários para seus anúncios são
              de <b>quinta a domingo entre 18:00 e 21:30</b>. Otimização
    ...
    },
    {
      ...
      subtitle:
        "Comunique-se de forma personalizada e segmentada para incentivar a recorrência sem parecer chato.",
        ...
        <div className="space-y-3.5">
          <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4">
            ...
            <div className="bg-white border border-slate-200/60 rounded-xl p-3 text-slate-600 text-xs space-y-1.5 leading-relaxed shadow-3xs">
              <p>
                Olá, <b>[Nome do Cliente]</b>! Que saudade de você! 😍
              </p>
              <p>
                Faz tempo que não vemos você por aqui. Para matar a saudade,
              ...
              <p className="text-[10px] text-slate-400 mt-2 font-mono">
                Disparar para: 142 clientes • Canal: WhatsApp
              </p>
            </div>
          </div>
    ...
    },
    {
      ...
      subtitle:
        "Uma experiência visual limpa, super rápida e intuitiva que estimula o cliente a adicionar mais itens.",
        ...
        <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 space-y-3">
          <div className="flex gap-2.5">
            <div className="flex-1 bg-white border border-slate-200/80 rounded-xl p-2.5 flex items-center justify-between shadow-2xs">
              ...
              <span className="text-[10px] bg-slate-100 p-1 px-2 rounded-lg text-slate-600 font-bold">
                Sugerido
              </span>
            </div>
          </div>
          ...
          <p className="text-[10px] text-center text-slate-400 font-semibold italic">
            ⭐ Aumenta o ticket médio em até 40% com sugestões cruzadas
          </p>
        </div>
      ),
    },
    {
      ...
      subtitle:
        "Tenha insights de altíssimo valor e clareza sobre o faturamento, produtos mais vendidos e clientes.",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-500 mt-4 text-sm md:text-base leading-relaxed">
            Conheça as funcionalidades que vão transformar o seu delivery,
            agilizar o seu operacional e multiplicar seu faturamento.
          </p>
        </div>
            ...
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  ...
                  <ChevronRight
                    size={16}
                    className={`text-slate-400 self-center transition-transform ${isActive ? "translate-x-1 text-blue-600" : "group-hover:translate-x-1"}`}
                  />
                </button>
              );
            })}
          ...
          <div className="lg:col-span-7">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-white rounded-3xl border border-slate-100 shadow-lg p-4 lg:p-6 md:p-8 flex flex-col justify-between h-full"
              >
                <div>
                  ...
                  <ul className="mt-6 space-y-2.5">
                    {activeFeature.checkpoints.map((pt, index) => (
                      <li
                        key={index}
                        className="flex items-start gap-2.5 text-xs text-slate-700 font-semibold leading-normal"
                      >
                        <span className="flex-shrink-0 w-5 h-5 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center font-bold">
                          ✓
                        </span>
                        <span>{pt}</span>
                      </li>
